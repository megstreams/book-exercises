...
words<-c("tree", "cat", "dog", "fire", "man", "candle", "tv")
...
word_bin<-function(words,letter1,letter2) words[substr(words,1,1)>=letter1 & substr(words,1,1)<=letter2]

# Use your `word_bin` function to determine which of your words start with "e" 
# through "q"
letter1<-"e"
letter2<-"q"
word_bin(words,letter1, letter2)
